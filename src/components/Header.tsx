    ...
    >
      <div
        style={{
          ...
          height: 30,
          borderRadius: "var(--radius)",
          background: iconRed ? "var(--accent-subtle)" : "var(--bg-base)",
          border: `1px solid ${iconRed ? "var(--accent-muted)" : "var(--border)"}`,
          display: "flex",
          alignItems: "center",
          ...
          flexShrink: 0,
          marginTop: 1,
          color: iconRed ? "var(--accent)" : "inherit",
        }}
      >
        {icon}
      </div>
      <div style={{ display: "flex", flexDirection: "column", gap: 1 }}>
        ...
        <span
          style={{ fontSize: 12, color: "var(--text-tertiary)", lineHeight: 1.35 }}
        >
          {desc}
        </span>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
        ...
        >
          <Image
            ...
            priority
          />
          <span style={{ fontWeight: 700, fontSize: 14, letterSpacing: "-0.4px" }}>
            TrustStar
          </span>
        </Link>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
        ...
        <div style={{ position: "relative" }}>
          <button
            ...
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLElement).style.background = moreOpen
                ? "var(--bg-hover)"
                : "none";
              (e.currentTarget as HTMLElement).style.color = moreOpen
                ? "var(--text-primary)"
                : "var(--text-secondary)";
            }}
          >
          ...
          <div style={moreDropdownStyle} onClick={(e) => e.stopPropagation()}>
            ...
            <DropdownItem
              ...
              title="Badge"
              desc="Embed your trust score"
            />
            <DropdownItem
              href="/recent"
              icon={<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16.24 7.76a6 6 0 0 1 0 8.49m-8.48-.01a6 6 0 0 1 0-8.49m11.31-2.82a10 10 0 0 1 0 14.14m-14.14 0a10 10 0 0 1 0-14.14"/><circle cx="12" cy="12" r="2"/></svg>}
              title="Recent Audits"
              desc="Live community feed"
            />
            <DropdownDivider />
            <DropdownItem
