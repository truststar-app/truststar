...
const PHRASE_ROWS: PhraseRowData[] = [
  { speed: 75, rtl: false, mobileHide: false, phrases: [
    ...
    { text: "$0.03 per star — popularity is for sale.", type: "stat", size: 19 },
    { text: "Would you run code nobody reviewed?", type: "question", size: 17 },
  ]},
  { speed: 55, rtl: true, mobileHide: false, phrases: [
    ...
    { text: "301,000 accounts. One fake star network.", type: "stat", size: 21 },
    { text: "Is the last commit from a real person?", type: "question", size: 15 },
  ]},
  { speed: 90, rtl: false, mobileHide: false, phrases: [
    ...
    { text: "90% of flagged repos were deleted by GitHub.", type: "stat", size: 16 },
  ]},
  { speed: 45, rtl: true, mobileHide: false, phrases: [
    ...
    { text: "Stars don't audit code.", type: "stat", size: 22 },
    { text: "When did this repo last get a real commit?", type: "question", size: 15 },
  ]},
  { speed: 65, rtl: false, mobileHide: true, phrases: [
    { text: "Who maintains this package?", type: "question", size: 19 },
    { text: "73% of devs ship packages with 0 active contributors.", type: "stat", size: 20 },
  ...
  { speed: 38, rtl: true, mobileHide: true, phrases: [
    ...
    { text: "Is the README the whole story?", type: "question", size: 18 },
  ]},
  { speed: 80, rtl: false, mobileHide: true, phrases: [
    ...
    { text: "Popularity can be bought. Trust cannot.", type: "stat", size: 20 },
    { text: "Who reviewed the last release?", type: "question", size: 16 },
  ]},
  { speed: 60, rtl: true, mobileHide: true, phrases: [
    ...
    { text: "Thousands of downloads. Zero real users.", type: "stat", size: 18 },
    { text: "Does this library call home?", type: "question", size: 17 },
  ]},
  { speed: 70, rtl: false, mobileHide: true, phrases: [
    { text: "16.66% of repos with 50+ stars bought them.", type: "stat", size: 19 },
    { text: "Is the commit history authentic?", type: "question", size: 17 },
    { text: "Your team trusts what you trust.", type: "stat", size: 22 },
    { text: "eval(atob(...)) — that's a red flag.", type: "stat", size: 18 },
    { text: "Who funds this open source project?", type: "question", size: 16 },
  ]},
  { speed: 50, rtl: true, mobileHide: true, phrases: [
    { text: "20 terabytes of GitHub metadata. 6 million lies.", type: "stat", size: 20 },
    { text: "Is this package too new to trust?", type: "question", size: 17 },
    { text: "Transparency first. Always.", type: "question", size: 26 },
    { text: "Lockstep starring — coordinated, fake, invisible.", type: "stat", size: 18 },
    { text: "Does this author have a real track record?", type: "question", size: 15 },
  ]},
];
